...
interface TupleServiceInterface
{
     ...
     * @param  int|null                          $maxItems          Maximum number of changes to retrieve (default: 100)
     ...
     * @param  string|null                       $relation    Filter by relation (optional)
     * @param  string|null                       $object      Filter by object (optional)
     * @param  int|null                          $maxItems    Maximum number of tuples to retrieve (null for all)
     ...
     * @param  TupleKeysInterface                $tupleKeys        The tuples to write
     * @param  bool                              $transactional    Whether to use transactional writes (default: true)
     * @param  bool                              $filterDuplicates Whether to filter duplicate tuples (default: true)
