 ...
 */
final class V1TupleToUserset implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'v1.TupleToUserset';
    ...
    private static $openAPITypes = [
        'tupleset' => '\OpenFGA\API\Model\ObjectRelation',
     ...
     * Sets tupleset.
     *
     * @param ObjectRelation $tupleset tupleset
     *
     * @return self
     */
    ...
    {
        if (null === $tupleset) {
            throw new InvalidArgumentException('non-nullable tupleset cannot be null');
        }
