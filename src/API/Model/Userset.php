...
final class Userset implements ArrayAccess, JsonSerializable, ModelInterface
{
    ...
    private static $openAPITypes = [
        'this' => 'object',
        'computedUserset' => '\OpenFGA\API\Model\ObjectRelation',
        'tupleToUserset' => '\OpenFGA\API\Model\V1TupleToUserset',
        'union' => '\OpenFGA\API\Model\Usersets',
        'intersection' => '\OpenFGA\API\Model\Usersets',
        'difference' => '\OpenFGA\API\Model\V1Difference',
    ];
