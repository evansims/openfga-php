 ...
 */
final class ReadAuthorizationModelResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ReadAuthorizationModelResponse';
    ...
    private static $openAPITypes = [
        'authorizationModel' => '\OpenFGA\API\Model\AuthorizationModel',
    ];
