 ...
 */
final class WriteRequestDeletes implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'WriteRequestDeletes';
    ...
    private static $openAPITypes = [
        'tupleKeys' => '\OpenFGA\API\Model\TupleKeyWithoutCondition[]',
    ];
