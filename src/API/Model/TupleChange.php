 ...
 */
final class TupleChange implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'TupleChange';
    ...
    private static $openAPITypes = [
        'tupleKey' => '\OpenFGA\API\Model\TupleKey',
        'operation' => '\OpenFGA\API\Model\TupleOperation',
        'timestamp' => '\DateTime',
    ];
     ...
     * Sets operation.
     *
     * @param TupleOperation $operation operation
     *
     * @return self
     */
