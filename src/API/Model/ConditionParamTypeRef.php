 ...
 */
final class ConditionParamTypeRef implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ConditionParamTypeRef';
    ...
    private static $openAPITypes = [
        'typeName' => '\OpenFGA\API\Model\TypeName',
        'genericTypes' => '\OpenFGA\API\Model\ConditionParamTypeRef[]',
    ];
