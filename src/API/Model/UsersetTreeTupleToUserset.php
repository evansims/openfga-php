 ...
 */
final class UsersetTreeTupleToUserset implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'UsersetTree.TupleToUserset';
    ...
    private static $openAPITypes = [
        'tupleset' => 'string',
        'computed' => '\OpenFGA\API\Model\Computed[]',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['computed']) {
     ...
     * Sets computed.
     *
     * @param Computed[] $computed computed
     *
     * @return self
     */
