 ...
 */
final class ReadAuthorizationModelsResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ReadAuthorizationModelsResponse';
    ...
    private static $openAPITypes = [
        'authorizationModels' => '\OpenFGA\API\Model\AuthorizationModel[]',
