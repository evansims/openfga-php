 ...
 */
final class ReadChangesResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ReadChangesResponse';
    ...
    private static $openAPITypes = [
        'changes' => '\OpenFGA\API\Model\TupleChange[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['changes']) {
     ...
     * Sets changes.
     *
     * @param TupleChange[] $changes changes
     *
     * @return self
     */
