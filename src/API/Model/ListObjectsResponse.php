 ...
 */
final class ListObjectsResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ListObjectsResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['objects']) {
