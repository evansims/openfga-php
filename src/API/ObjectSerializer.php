...
use OpenFGA\API\Model\ModelInterface;
use SplFileObject;
...
final class ObjectSerializer
{
    ...
    public static function buildQuery(array $params, $encoding = PHP_QUERY_RFC3986): string
    {
        ...
        if (false === $encoding) {
            $encoder = static fn (string $str): string => $str;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ('\DateTime' === $class) {
            ...
            if (! empty($data)) {
                try {
                    ...
                    return new DateTimeImmutable(self::sanitizeTimestamp($data));
                }
            } else {
                return null;
            }
        ...
        if (! empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
            $subclass = '\OpenFGA\API\Model\\' . $data->{$discriminator};
    ...
    public static function toQueryValue(
        ...
        if ('\\DateTime' === $openApiType && $value instanceof DateTimeImmutable) {
