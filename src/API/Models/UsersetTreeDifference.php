 ...
 */
final class UsersetTreeDifference implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'UsersetTree.Difference';
    ...
    private static $openAPITypes = [
        'base' => '\OpenFGA\API\Models\Node',
        'subtract' => '\OpenFGA\API\Models\Node',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subtract', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['base']) {
            $invalidProperties[] = "'base' can't be null";
        }
        if (null === $this->container['subtract']) {
    ...
    {
        if (null === $subtract) {
            throw new InvalidArgumentException('non-nullable subtract cannot be null');
        }
