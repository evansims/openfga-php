 ...
 */
final class Usersets implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'Usersets';
    ...
    private static $openAPITypes = [
        'child' => '\OpenFGA\API\Models\Userset[]',
    ];
