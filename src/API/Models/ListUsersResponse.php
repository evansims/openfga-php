 ...
 */
final class ListUsersResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ListUsersResponse';
