 ...
 */
final class ExpandResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'ExpandResponse';
    ...
    private static $openAPITypes = [
        'tree' => '\OpenFGA\API\Models\UsersetTree',
    ];
     ...
     * Sets tree.
     *
     * @param null|UsersetTree $tree tree
     *
     * @return self
     */
