 ...
 */
final class Tuple implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'Tuple';
    ...
    private static $openAPITypes = [
        'key' => '\OpenFGA\API\Models\TupleKey',
        'timestamp' => '\DateTime',
    ];
