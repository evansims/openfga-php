 ...
 */
final class WriteAuthorizationModelResponse implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'WriteAuthorizationModelResponse';
