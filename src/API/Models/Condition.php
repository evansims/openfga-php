 ...
 */
final class Condition implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'Condition';
    ...
    private static $openAPITypes = [
        'name' => 'string',
        'expression' => 'string',
        'parameters' => 'array<string,\OpenFGA\API\Models\ConditionParamTypeRef>',
        'metadata' => '\OpenFGA\API\Models\ConditionMetadata',
    ];
     ...
     * Gets parameters.
     *
     * @return null|array<string,ConditionParamTypeRef>
     */
     ...
     * Sets metadata.
     *
     * @param null|ConditionMetadata $metadata metadata
     *
     * @return self
     */
     ...
     * Sets parameters.
     *
     * @param null|array<string,ConditionParamTypeRef> $parameters A map of parameter names to the parameter's defined type reference.
     *
     * @return self
     */
