 ...
 */
final class Node implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'Node';
    ...
    private static $openAPITypes = [
        'name' => 'string',
        'leaf' => '\OpenFGA\API\Models\Leaf',
        'difference' => '\OpenFGA\API\Models\UsersetTreeDifference',
        'union' => '\OpenFGA\API\Models\Nodes',
        'intersection' => '\OpenFGA\API\Models\Nodes',
    ];
     ...
     * Gets difference.
     *
     * @return null|UsersetTreeDifference
     */
     ...
     * Sets difference.
     *
     * @param null|UsersetTreeDifference $difference difference
     *
     * @return self
     */
     ...
     * Sets intersection.
     *
     * @param null|Nodes $intersection intersection
     *
     * @return self
     */
