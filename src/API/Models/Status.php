 ...
 */
final class Status implements ArrayAccess, JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    private static $openAPIModelName = 'Status';
    ...
    private static $openAPITypes = [
        'code' => 'int',
        'message' => 'string',
        'details' => '\OpenFGA\API\Models\Any[]',
    ];
     ...
     * Sets details.
     *
     * @param null|Any[] $details details
     *
     * @return self
     */
