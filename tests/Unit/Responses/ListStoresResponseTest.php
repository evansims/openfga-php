...
describe('ListStoresResponse', function (): void {
    ...
    test('constructs with stores only', function (): void {
        $store1 = new Store(
            id: 'store-1',
            name: 'First Store',
    ...
    test('handles stores with deletedAt', function (): void {
    ...
    test('handles stores with various timestamps', function (): void {
        $store1 = new Store(
            id: 'store-micro',
