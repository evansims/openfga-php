...
test('CreateStoreResponse implements CreateStoreResponseInterface', function (): void {
...
test('CreateStoreResponse constructs and returns properties', function (): void {
...
test('CreateStoreResponse schema returns expected structure', function (): void {
...
test('CreateStoreResponse schema is cached', function (): void {
...
test('CreateStoreResponse handles empty store name', function (): void {
    $response = new CreateStoreResponse(
        'id-123',
        '',
        new DateTimeImmutable(),
...
test('CreateStoreResponse handles UUID format store ID', function (): void {
...
test('CreateStoreResponse preserves exact timestamp precision', function (): void {
