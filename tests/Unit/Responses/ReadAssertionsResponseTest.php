...
test('ReadAssertionsResponse constructs with assertions and model', function (): void {
...
test('ReadAssertionsResponse constructs with null assertions', function (): void {
    $model = 'model-123';
...
test('ReadAssertionsResponse constructs with empty assertions collection', function (): void {
    $assertions = new Assertions([]);
    $model = 'model-456';
    $response = new ReadAssertionsResponse($assertions, $model);
...
test('ReadAssertionsResponse handles single assertion', function (): void {
    $tupleKey = new AssertionTupleKey(
        user: 'user:bob',
        relation: 'owner',
...
test('ReadAssertionsResponse handles multiple assertions', function (): void {
...
test('ReadAssertionsResponse schema returns correct structure', function (): void {
...
test('ReadAssertionsResponse schema is cached', function (): void {
...
test('ReadAssertionsResponse handles response data with null assertions', function (): void {
...
test('ReadAssertionsResponse handles empty assertions array data', function (): void {
    $assertions = new Assertions([]);
    $response = new ReadAssertionsResponse($assertions, 'model-789');
...
test('ReadAssertionsResponse handles UUID format model IDs', function (): void {
...
test('ReadAssertionsResponse handles large assertion collections', function (): void {
    $assertions = [];
    for ($i = 0; $i < 50; ++$i) {
        $tupleKey = new AssertionTupleKey(
            user: "user:user{$i}",
...
test('ReadAssertionsResponse handles complex assertion expectations', function (): void {
    $tupleKey1 = new AssertionTupleKey(
