...
describe('CheckResponse', function (): void {
    ...
    test('can be instantiated with partial parameters', function (): void {
    ...
    test('returns correct schema', function (): void {
    ...
    test('creates response from successful HTTP response', function (): void {
    ...
    test('handles non-200 status codes', function (): void {
        $stream = test()->createMock(StreamInterface::class);
        $stream->method('__toString')
