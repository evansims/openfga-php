...
use OpenFGA\Schemas\{Schema, SchemaProperty};

describe('Schema', function (): void {
    test('can be created with class name', function (): void {
    ...
    test('can be created with properties', function (): void {
    ...
    test('properties are indexed by name', function (): void {
        $property1 = new SchemaProperty('name', 'string');
