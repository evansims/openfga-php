...
it('handles standard "but not" spacing correctly', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles extra spacing in "but not" correctly', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles uppercase "BUT NOT" correctly', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles mixed case "But Not" correctly', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles tabs around "but not" correctly', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles multiple "but not" operations correctly', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles complex expressions with parentheses and "but not"', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('handles "but not" with mixed operators and various spacing', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
...
it('correctly generates DSL output with proper "but not" formatting', function (): void {
    $dsl = <<<'DSL'
        model
          schema 1.1
