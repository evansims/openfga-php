...
describe('DslTransformerValidation', function (): void {
    ...
    test('throws exception for deeply nested unbalanced parentheses', function (): void {
        $dsl = <<<'DSL'
            model
              schema 1.1
    ...
    test('validates parentheses in tuple-to-userset expressions', function (): void {
        $dsl = <<<'DSL'
            model
              schema 1.1
