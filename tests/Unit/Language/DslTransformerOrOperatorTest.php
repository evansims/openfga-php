...
describe('DslTransformerOrOperator', function (): void {
    ...
    test('verifies "or" operator already uses regex for flexible matching', function (): void {
        $dsl = <<<'DSL'
            model
              schema 1.1
    ...
    test('handles mixed case OR correctly', function (): void {
        $dsl = <<<'DSL'
            model
              schema 1.1
