...
test('ListUsersRequest implements ListUsersRequestInterface', function (): void {
...
test('ListUsersRequest constructs with required parameters', function (): void {
    $userFilters = new UserTypeFilters(
...
test('ListUsersRequest constructs with all parameters', function (): void {
...
test('ListUsersRequest getRequest returns RequestContext with minimal body', function (): void {
    $userFilters = new UserTypeFilters(new UserTypeFilter('user'));
...
test('ListUsersRequest getRequest returns RequestContext with full body', function (): void {
    $userFilters = new UserTypeFilters(
        new UserTypeFilter('user'),
        new UserTypeFilter('group', 'members'),
    );
...
test('ListUsersRequest handles empty user filters', function (): void {
    $userFilters = new UserTypeFilters();
...
test('ListUsersRequest handles complex context objects', function (): void {
    $userFilters = new UserTypeFilters(new UserTypeFilter('user'));
    $context = (object) [
        'nested' => (object) [
            'deep' => ['array' => true],
