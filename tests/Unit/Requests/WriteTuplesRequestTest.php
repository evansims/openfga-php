...
describe('WriteTuplesRequest', function (): void {
    ...
    test('implements WriteTuplesRequestInterface', function (): void {
    ...
    test('constructs with writes only', function (): void {
    ...
    test('constructs with deletes only', function (): void {
    ...
    test('constructs with both writes and deletes', function (): void {
        $writes = new TupleKeys(
    ...
    test('getRequest returns RequestContext with model only', function (): void {
        $request = new WriteTuplesRequest(
            store: 'test-store',
            model: 'model-123',
        );
    ...
    test('getRequest returns RequestContext with writes', function (): void {
        $writes = new TupleKeys(
    ...
    test('getRequest returns RequestContext with deletes', function (): void {
        $deletes = new TupleKeys(
    ...
    test('getRequest returns RequestContext with both writes and deletes', function (): void {
        $writes = new TupleKeys(
