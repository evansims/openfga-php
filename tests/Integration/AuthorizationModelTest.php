...
beforeEach(function (): void {
    ...
    // Create a test store for authorization model tests
...
test('handles complex authorization model with conditions', function (): void {
    $dsl = '
        model
          schema 1.1
    ...
    // Verify complex model can be retrieved
    $getResponse = $this->client->getAuthorizationModel(
        store: $this->storeId,
    ...
    // Find document type and verify relations
    $documentType = null;
