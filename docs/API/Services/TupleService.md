...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L55)
...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L91)
...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L179)
...
| `$user`        | `string` &#124; `null`                                       | Filter by user (optional)                           |
| `$relation`    | `string` &#124; `null`                                       | Filter by relation (optional)                       |
| `$object`      | `string` &#124; `null`                                       | Filter by object (optional)                         |
| `$maxItems`    | `int` &#124; `null`                                          | Maximum number of tuples to retrieve (null for all) |
| `$consistency` | [`Consistency`](Models/Enums/Consistency.md) &#124; `null`   | Read consistency level (optional)                   |

#### Returns

[`SuccessInterface`](Results/SuccessInterface.md) — Success with tuples collection, or Failure with error details
...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L235)
...
| `$tupleKeys`        | [`TupleKeysInterface`](Models/Collections/TupleKeysInterface.md) | The tuples to write                                 |
| `$transactional`    | `bool`                                                           | Whether to use transactional writes (default: true) |
| `$filterDuplicates` | `bool`                                                           | Whether to filter duplicate tuples (default: true)  |
...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L141)
...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L161)
...
| `$maxItems`          | `int` &#124; `null`                                          | Maximum number of changes to retrieve (default: 100) |

#### Returns

[`SuccessInterface`](Results/SuccessInterface.md) — Success with changes collection, or Failure with error details
...
[View source](https://github.com/evansims/openfga-php/blob/main/src/Services/TupleService.php#L123)
